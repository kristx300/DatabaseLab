...
-- Generated from EDMX file: C:\Users\maels\Documents\Visual Studio 2017\Projects\DatabaseForms\DatabaseForms\OnlineShop.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_OrderDelivery]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderSet] DROP CONSTRAINT [FK_OrderDelivery];
GO
