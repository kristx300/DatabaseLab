...
{
    public partial class DeliveryGridForm : Form
    {
        ...
        {
            string sql = "SELECT * FROM DeliverySet";
            ...
            sDs = new DataSet();
            sAdapter.Fill(sDs, "DeliverySet");
            sTable = sDs.Tables["DeliverySet"];
            connection.Close();
            UserDataGridView.DataSource = sDs.Tables["DeliverySet"];
